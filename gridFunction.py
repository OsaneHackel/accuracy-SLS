...
def trainval_grid(exp_dict, savedir_base, datadir, reset=False, metrics_flag=True, lr_step_schedule='constant', lr_step_gamma=0.1):
    # bookkeeping
    # ---------------
    ...
    for epoch in range(s_epoch, exp_dict['max_epoch']):
        ...
        s_time = time.time()
        for images,labels in tqdm.tqdm(train_loader):    #tqdm wird verwendet um die wachsenden weissen Balken zu erzeugen
...
if __name__ == '__main__':
    ...
    for exp_dict in exp_list:
        # do trainval
        trainval_grid(exp_dict=exp_dict,
