...
class Sls(torch.optim.Optimizer):
    ...
    def step(self, closure):
        ...
        #print(f"step size:{batch_step_size}") # diag
        ...
        for group in self.param_groups:
            ...
            #print(f"current gradients {grad_current}") #diag
            grad_norm = ut.compute_grad_norm(grad_current)
            #print(f"gradient norm {grad_norm}") # diag
                ...
                if grad_norm >= 1e-8:
                    ...
                    for e in range(100):
                        ...
                        if group['line_search_fn'] == "armijo":
                            ...
                            #print(f"armijo results: \n found: {found} step_size: {step_size} step size old: {step_size_old}") #diag
                            if found == 1:
                                #print(f"number of iterations: {e}")
                                break
