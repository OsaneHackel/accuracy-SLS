...
import accSls.lossUtils as lt


class LossSls(torch.optim.Optimizer):
    """Implements loss based stochastic line search.
            ...
            with torch.no_grad():
                if grad_norm >= 1e-8:
                    ...
                    for e in range(10):
                        ...
                        ut.try_sgd_update(params, step_size,
                        ...
                        if group['line_search_fn'] == "armijo":
                            armijo_results = lt.check_armijo_conditions_loss(step_size=step_size,
